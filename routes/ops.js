...
router.get("/ticket-categories", requireAuth, (req, res) => res.json(db.load().ticketCategories));
...
router.patch("/tickets/:id", requireAuth, requireRole("yonetici", "personel"), (req, res) => {
  const data = db.load();
...
router.get("/personnel", requireAuth, (req, res) => res.json(db.load().personnel));

router.patch("/personnel/:id", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.get("/equipment", requireAuth, requireRole("yonetici", "personel"), (req, res) => {
  const data = db.load();
  const now = Date.now();
...
router.post("/equipment", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.delete("/equipment/:id", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.patch("/equipment/:id/maintained", requireAuth, requireRole("yonetici", "personel"), (req, res) => {
  const data = db.load();
...
router.post("/equipment/:id/undo-maintained", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
  const e = data.equipment.find((x) => x.id === req.params.id);
  if (!e) return res.status(404).json({ error: "Demirbaş bulunamadı." });
...
router.get("/meters", requireAuth, (req, res) => {
  const data = db.load();
...
router.post("/meters", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.get("/meter-readings", requireAuth, (req, res) => {
  const data = db.load();
...
router.post("/meter-readings", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.delete("/meter-readings/:id", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.post("/packages", requireAuth, requireRole("yonetici", "personel"), (req, res) => {
  const data = db.load();
...
router.patch("/packages/:id/deliver", requireAuth, requireRole("yonetici", "personel"), (req, res) => {
  const data = db.load();
...
router.patch("/packages/:id/undo-deliver", requireAuth, requireRole("yonetici", "personel"), (req, res) => {
  const data = db.load();
  const p = data.packages.find((x) => x.id === req.params.id);
  if (!p) return res.status(404).json({ error: "Kargo kaydı bulunamadı." });
...
router.delete("/packages/:id", requireAuth, requireRole("yonetici", "personel"), (req, res) => {
  const data = db.load();
...
router.post("/decisions", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.get("/keys", requireAuth, requireRole("yonetici", "personel"), (req, res) => res.json(db.load().keys));

router.post("/keys", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.patch("/keys/:id/checkout", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.patch("/keys/:id/checkin", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
  const k = data.keys.find((x) => x.id === req.params.id);
  if (!k) return res.status(404).json({ error: "Anahtar bulunamadı." });
  k.status = "depoda";
