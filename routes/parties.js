...
router.get("/vendors", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
  res.json(data.vendors.map((v) => ({ ...v, debt: partyDebt(data, "firma", v.id) })));
});

router.post("/vendors", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.delete("/vendors/:id", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.get("/party-charges", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.post("/party-charges", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.get("/party-payments", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.post("/party-payments/pay", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.post("/party-payments/:id/cancel", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
...
router.delete("/party-charges/:id", requireAuth, requireRole("yonetici"), (req, res) => {
  const data = db.load();
